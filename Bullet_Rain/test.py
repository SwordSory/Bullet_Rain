...
def random_speed_giver():
    random_speed = random.randint(int(height*5/972), int(height*25/972))
    return random_speed

def to_x_giver():
    random_x = random.randint(width*5/864, width-width*(5/216))
    return random_x

def random_y_giver():
    random_y = random.randint(height*5/486, height-height*(151/486))
    return random_y
